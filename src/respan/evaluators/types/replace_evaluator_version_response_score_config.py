...
class ReplaceEvaluatorVersionResponseScoreConfig(UniversalBaseModel):
    """
    ...
    choices: typing.Optional[typing.List[ReplaceEvaluatorVersionResponseScoreConfigChoicesItem]] = None
