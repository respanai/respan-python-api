...
class UpdateEvaluatorVersionRequestScoreConfig(UniversalBaseModel):
    """
    ...
    choices: typing.Optional[typing.List[UpdateEvaluatorVersionRequestScoreConfigChoicesItem]] = None
