...
class CreateEvaluatorVersionRequestScoreConfig(UniversalBaseModel):
    """
    ...
    choices: typing.Optional[typing.List[CreateEvaluatorVersionRequestScoreConfigChoicesItem]] = None
