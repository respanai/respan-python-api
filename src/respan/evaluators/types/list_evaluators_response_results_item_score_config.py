...
class ListEvaluatorsResponseResultsItemScoreConfig(UniversalBaseModel):
    """
    ...
    choices: typing.Optional[typing.List[ListEvaluatorsResponseResultsItemScoreConfigChoicesItem]] = None
