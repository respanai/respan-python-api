...
class ReplaceEvaluatorVersionRequestScoreConfig(UniversalBaseModel):
    """
    ...
    choices: typing.Optional[typing.List[ReplaceEvaluatorVersionRequestScoreConfigChoicesItem]] = None
