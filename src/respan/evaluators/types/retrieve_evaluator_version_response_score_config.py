...
class RetrieveEvaluatorVersionResponseScoreConfig(UniversalBaseModel):
    """
    ...
    choices: typing.Optional[typing.List[RetrieveEvaluatorVersionResponseScoreConfigChoicesItem]] = None
