...
class CreateEvaluatorVersionResponseScoreConfig(UniversalBaseModel):
    """
    ...
    choices: typing.Optional[typing.List[CreateEvaluatorVersionResponseScoreConfigChoicesItem]] = None
