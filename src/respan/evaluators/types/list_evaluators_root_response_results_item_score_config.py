...
class ListEvaluatorsRootResponseResultsItemScoreConfig(UniversalBaseModel):
    """
    ...
    choices: typing.Optional[typing.List[ListEvaluatorsRootResponseResultsItemScoreConfigChoicesItem]] = None
