...
class PublicEvaluatorList(UniversalBaseModel):
    """
    User-friendly serializer for evaluator list view via API.
    """
    ...
    eval_class: typing.Optional[PublicEvaluatorListEvalClass] = None
