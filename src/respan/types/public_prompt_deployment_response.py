...
class PublicPromptDeploymentResponse(UniversalBaseModel):
    ...
    thinking: typing.Optional[PublicPromptDeploymentResponseThinking] = None
    tool_choice: typing.Optional[PublicPromptDeploymentResponseToolChoice] = None
