...
class PublicPromptDeploymentResponseRequest(UniversalBaseModel):
    ...
    thinking: typing.Optional[PublicPromptDeploymentResponseRequestThinking] = None
    tool_choice: typing.Optional[PublicPromptDeploymentResponseRequestToolChoice] = None
