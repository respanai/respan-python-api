...
class PromptVersionList(UniversalBaseModel):
    ...
    thinking: typing.Optional[PromptVersionListThinking] = None
    tool_choice: typing.Optional[PromptVersionListToolChoice] = None
