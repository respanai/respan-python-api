...
class SavedFilterCreate(UniversalBaseModel):
    name: str
    ...
    environment: typing.Optional[SavedFilterCreateEnvironment] = None
    display_settings: typing.Optional[SavedFilterCreateDisplaySettings] = None
