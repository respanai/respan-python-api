...
from .patched_public_prompt_version_update_request_tool_choice import PatchedPublicPromptVersionUpdateRequestToolChoice
...
class PatchedPublicPromptVersionUpdateRequest(UniversalBaseModel):
    ...
    thinking: typing.Optional[PatchedPublicPromptVersionUpdateRequestThinking] = None
    tool_choice: typing.Optional[PatchedPublicPromptVersionUpdateRequestToolChoice] = None
