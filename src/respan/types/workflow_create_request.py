...
from .workflow_create_request_tasks_item import WorkflowCreateRequestTasksItem
...
class WorkflowCreateRequest(UniversalBaseModel):
    """
    Validate workflow task structure on create/update via validate_workflow_structure().
    """

    id: typing.Optional[str] = None
    tasks: typing.Optional[typing.List[WorkflowCreateRequestTasksItem]] = None
    ...
    * `ingests` - Ingest
    ...
    trigger_event_type: typing.Optional[WorkflowCreateRequestTriggerEventType] = pydantic.Field(default=None)
    """
...
update_forward_refs(WorkflowCreateRequest)
