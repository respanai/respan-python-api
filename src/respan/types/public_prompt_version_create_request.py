...
class PublicPromptVersionCreateRequest(UniversalBaseModel):
    ...
    thinking: typing.Optional[PublicPromptVersionCreateRequestThinking] = None
    tool_choice: typing.Optional[PublicPromptVersionCreateRequestToolChoice] = None
