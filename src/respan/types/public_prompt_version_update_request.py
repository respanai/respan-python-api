...
class PublicPromptVersionUpdateRequest(UniversalBaseModel):
    ...
    thinking: typing.Optional[PublicPromptVersionUpdateRequestThinking] = None
    tool_choice: typing.Optional[PublicPromptVersionUpdateRequestToolChoice] = None
