...
class PromptVersionListRequest(UniversalBaseModel):
    ...
    thinking: typing.Optional[PromptVersionListRequestThinking] = None
    tool_choice: typing.Optional[PromptVersionListRequestToolChoice] = None
