...
class PublicPromptVersionListRequest(UniversalBaseModel):
    ...
    thinking: typing.Optional[PublicPromptVersionListRequestThinking] = None
    tool_choice: typing.Optional[PublicPromptVersionListRequestToolChoice] = None
