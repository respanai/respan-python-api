...
class PublicPromptVersionDetailRequest(UniversalBaseModel):
    ...
    thinking: typing.Optional[PublicPromptVersionDetailRequestThinking] = None
    tool_choice: typing.Optional[PublicPromptVersionDetailRequestToolChoice] = None
