...
class PublicPromptCommitResponseRequest(UniversalBaseModel):
    ...
    thinking: typing.Optional[PublicPromptCommitResponseRequestThinking] = None
    tool_choice: typing.Optional[PublicPromptCommitResponseRequestToolChoice] = None
