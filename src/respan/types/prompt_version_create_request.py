...
class PromptVersionCreateRequest(UniversalBaseModel):
    ...
    thinking: typing.Optional[PromptVersionCreateRequestThinking] = None
    tool_choice: typing.Optional[PromptVersionCreateRequestToolChoice] = None
