...
class PublicPromptVersionCreate(UniversalBaseModel):
    ...
    thinking: typing.Optional[PublicPromptVersionCreateThinking] = None
    tool_choice: typing.Optional[PublicPromptVersionCreateToolChoice] = None
