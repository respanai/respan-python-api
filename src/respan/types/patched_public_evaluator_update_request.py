...
class PatchedPublicEvaluatorUpdateRequest(UniversalBaseModel):
    """
    User-friendly serializer for updating evaluators via API.
    Supports partial updates of configuration fields.
    """
