...
class PublicPromptVersionList(UniversalBaseModel):
    ...
    thinking: typing.Optional[PublicPromptVersionListThinking] = None
    tool_choice: typing.Optional[PublicPromptVersionListToolChoice] = None
