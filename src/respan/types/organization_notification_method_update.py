...
class OrganizationNotificationMethodUpdate(UniversalBaseModel):
    """
    Serializer for updating existing organization notification methods.
    """

    id: typing.Optional[str] = None
    notification_config: OrganizationNotificationMethodUpdateNotificationConfig
