...
class PromptVersionDetail(UniversalBaseModel):
    ...
    thinking: typing.Optional[PromptVersionDetailThinking] = None
    tool_choice: typing.Optional[PromptVersionDetailToolChoice] = None
