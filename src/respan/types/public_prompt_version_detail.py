...
class PublicPromptVersionDetail(UniversalBaseModel):
    ...
    thinking: typing.Optional[PublicPromptVersionDetailThinking] = None
    tool_choice: typing.Optional[PublicPromptVersionDetailToolChoice] = None
    ...
    edited_by: typing.Optional[Editor] = None
