...
from .workflow_update_tasks_item import WorkflowUpdateTasksItem
...
class WorkflowUpdate(UniversalBaseModel):
    """
    Validate workflow task structure on create/update via validate_workflow_structure().
    """

    id: typing.Optional[str] = None
    tasks: typing.Optional[typing.List[WorkflowUpdateTasksItem]] = None
    ...
    * `ingests` - Ingest
    ...
    trigger_event_type: typing.Optional[WorkflowUpdateTriggerEventType] = pydantic.Field(default=None)
    """
...
update_forward_refs(WorkflowUpdate)
