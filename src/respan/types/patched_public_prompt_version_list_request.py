...
class PatchedPublicPromptVersionListRequest(UniversalBaseModel):
    ...
    thinking: typing.Optional[PatchedPublicPromptVersionListRequestThinking] = None
    tool_choice: typing.Optional[PatchedPublicPromptVersionListRequestToolChoice] = None
