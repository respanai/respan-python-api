...
class PublicPromptVersionUpdate(UniversalBaseModel):
    ...
    thinking: typing.Optional[PublicPromptVersionUpdateThinking] = None
    tool_choice: typing.Optional[PublicPromptVersionUpdateToolChoice] = None
