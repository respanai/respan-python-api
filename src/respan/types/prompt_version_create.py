...
class PromptVersionCreate(UniversalBaseModel):
    ...
    thinking: typing.Optional[PromptVersionCreateThinking] = None
    tool_choice: typing.Optional[PromptVersionCreateToolChoice] = None
