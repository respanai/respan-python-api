...
class UpdateScoreResponse(UniversalBaseModel):
    ...
    type: typing.Optional[UpdateScoreResponseType] = pydantic.Field(default=None)
    """
    ...
    inputs: typing.Optional[UpdateScoreResponseInputs] = pydantic.Field(default=None)
    """
