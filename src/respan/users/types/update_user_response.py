...
class UpdateUserResponse(UniversalBaseModel):
    ...
    environment: typing.Optional[UpdateUserResponseEnvironment] = pydantic.Field(default=None)
    """
    ...
    budget_duration: typing.Optional[UpdateUserResponseBudgetDuration] = pydantic.Field(default=None)
    """
