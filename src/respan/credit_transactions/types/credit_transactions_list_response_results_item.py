...
class CreditTransactionsListResponseResultsItem(UniversalBaseModel):
    ...
    transaction_type: typing.Optional[CreditTransactionsListResponseResultsItemTransactionType] = pydantic.Field(
        default=None
    )
    """
    Transaction type.
