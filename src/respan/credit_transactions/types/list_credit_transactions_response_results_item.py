...
class ListCreditTransactionsResponseResultsItem(UniversalBaseModel):
    ...
    transaction_type: typing.Optional[ListCreditTransactionsResponseResultsItemTransactionType] = pydantic.Field(
        default=None
    )
    """
    Transaction type.
