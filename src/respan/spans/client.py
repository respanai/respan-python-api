...
class SpansClient:
    ...
    def request_logs_groups_list(
        ...
        *,
        ...
        client.spans.request_logs_groups_list()
        """
        _response = self._raw_client.request_logs_groups_list(
            group_by=group_by,
            sort_by=sort_by,
            start_time=start_time,
            end_time=end_time,
    ...
    def request_logs_groups_filter(
        ...
        *,
        ...
        client.spans.request_logs_groups_filter()
        """
        _response = self._raw_client.request_logs_groups_filter(
            group_by=group_by,
            sort_by=sort_by,
            start_time=start_time,
            end_time=end_time,
...
class AsyncSpansClient:
    ...
    async def request_logs_groups_list(
        ...
        *,
        ...
        async def main() -> None:
            await client.spans.request_logs_groups_list()


        asyncio.run(main())
        """
        _response = await self._raw_client.request_logs_groups_list(
            group_by=group_by,
            sort_by=sort_by,
            start_time=start_time,
            end_time=end_time,
    ...
    async def request_logs_groups_filter(
        ...
        *,
        ...
        async def main() -> None:
            await client.spans.request_logs_groups_filter()


        asyncio.run(main())
        """
        _response = await self._raw_client.request_logs_groups_filter(
            group_by=group_by,
            sort_by=sort_by,
            start_time=start_time,
            end_time=end_time,
