...
class IngestSpansRequestBodyItem(UniversalBaseModel):
    ...
    log_type: typing.Optional[IngestSpansRequestBodyItemLogType] = pydantic.Field(default=None)
    """
    Type of span.
    """
    ...
    status: typing.Optional[IngestSpansRequestBodyItemStatus] = pydantic.Field(default=None)
    """
    Request status.
    """
