...
class CreateTraceLegacyRequestZeroItem(UniversalBaseModel):
    ...
    log_type: typing.Optional[CreateTraceLegacyRequestZeroItemLogType] = pydantic.Field(default=None)
    """
    Span type.
    """
    ...
    status: typing.Optional[CreateTraceLegacyRequestZeroItemStatus] = None
