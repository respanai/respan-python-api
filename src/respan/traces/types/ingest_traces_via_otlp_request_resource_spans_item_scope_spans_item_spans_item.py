...
class IngestTracesViaOtlpRequestResourceSpansItemScopeSpansItemSpansItem(UniversalBaseModel):
    ...
    status: typing.Optional[IngestTracesViaOtlpRequestResourceSpansItemScopeSpansItemSpansItemStatus] = pydantic.Field(
        default=None
    )
    """
    Span status.
    ...
    attributes: typing.Optional[
        typing.List[IngestTracesViaOtlpRequestResourceSpansItemScopeSpansItemSpansItemAttributesItem]
