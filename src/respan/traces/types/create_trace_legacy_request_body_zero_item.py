...
class CreateTraceLegacyRequestBodyZeroItem(UniversalBaseModel):
    ...
    log_type: typing.Optional[CreateTraceLegacyRequestBodyZeroItemLogType] = pydantic.Field(default=None)
    """
    Span type.
    """
    ...
    status: typing.Optional[CreateTraceLegacyRequestBodyZeroItemStatus] = None
