...
class CreateTraceLegacyRequestDataDataItem(UniversalBaseModel):
    ...
    log_type: typing.Optional[CreateTraceLegacyRequestDataDataItemLogType] = pydantic.Field(default=None)
    """
    Span type.
    """
    ...
    status: typing.Optional[CreateTraceLegacyRequestDataDataItemStatus] = None
