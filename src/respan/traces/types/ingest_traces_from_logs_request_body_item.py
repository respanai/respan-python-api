...
class IngestTracesFromLogsRequestBodyItem(UniversalBaseModel):
    ...
    log_type: typing.Optional[IngestTracesFromLogsRequestBodyItemLogType] = pydantic.Field(default=None)
    """
    Span type.
    """
    ...
    status: typing.Optional[IngestTracesFromLogsRequestBodyItemStatus] = None
