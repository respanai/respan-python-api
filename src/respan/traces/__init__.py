...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "CreateTraceLegacyRequestDataDataItemLogType": ".types",
    "CreateTraceLegacyRequestDataDataItemStatus": ".types",
    "CreateTraceLegacyRequestZeroItem": ".types",
    "CreateTraceLegacyRequestZeroItemLogType": ".types",
    "CreateTraceLegacyRequestZeroItemStatus": ".types",
