...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "IngestTracesFromLogsRequestBodyItem": ".types",
    "IngestTracesFromLogsRequestBodyItemLogType": ".types",
    "IngestTracesFromLogsRequestBodyItemStatus": ".types",
    "IngestTracesFromLogsResponse": ".types",
    "IngestTracesViaOtlpRequestResourceSpansItem": ".types",
    "IngestTracesViaOtlpRequestResourceSpansItemResource": ".types",
    "IngestTracesViaOtlpRequestResourceSpansItemResourceAttributesItem": ".types",
    "IngestTracesViaOtlpRequestResourceSpansItemScopeSpansItem": ".types",
    "IngestTracesViaOtlpRequestResourceSpansItemScopeSpansItemScope": ".types",
    "IngestTracesViaOtlpRequestResourceSpansItemScopeSpansItemSpansItem": ".types",
    "IngestTracesViaOtlpRequestResourceSpansItemScopeSpansItemSpansItemAttributesItem": ".types",
