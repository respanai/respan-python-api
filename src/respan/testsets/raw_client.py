...
from .types.create_testset_rows_request_testset_rows_item import CreateTestsetRowsRequestTestsetRowsItem
from .types.create_testset_rows_response_item import CreateTestsetRowsResponseItem
...
class RawTestsetsClient:
    ...
    def create_testset_rows(
        ...
        testset_id: str,
        *,
        testset_rows: typing.Sequence[CreateTestsetRowsRequestTestsetRowsItem],
        request_options: typing.Optional[RequestOptions] = None,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="POST",
            json={
                "testset_rows": convert_and_respect_annotation_metadata(
                    object_=testset_rows,
                    annotation=typing.Sequence[CreateTestsetRowsRequestTestsetRowsItem],
                    direction="write",
                ),
            },
            headers={
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=typing.List[CreateTestsetRowsResponseItem],  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
