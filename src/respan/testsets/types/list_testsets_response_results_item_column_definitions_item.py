...
class ListTestsetsResponseResultsItemColumnDefinitionsItem(UniversalBaseModel):
    ...
    type: typing.Optional[ListTestsetsResponseResultsItemColumnDefinitionsItemType] = pydantic.Field(default=None)
    """
    Column value type.
    """
