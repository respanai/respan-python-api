...
class ReplaceTestsetRequestColumnDefinitionsItem(UniversalBaseModel):
    ...
    type: typing.Optional[ReplaceTestsetRequestColumnDefinitionsItemType] = pydantic.Field(default=None)
    """
    Column value type.
    """
