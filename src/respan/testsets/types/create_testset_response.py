...
class CreateTestsetResponse(UniversalBaseModel):
    ...
    column_definitions: typing.Optional[typing.List[CreateTestsetResponseColumnDefinitionsItem]] = pydantic.Field(
        default=None
    )
    """
