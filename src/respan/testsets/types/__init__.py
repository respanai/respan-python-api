...
if typing.TYPE_CHECKING:
    ...
    from .create_testset_rows_request_testset_rows_item import CreateTestsetRowsRequestTestsetRowsItem
    from .create_testset_rows_response_item import CreateTestsetRowsResponseItem
...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "CreateTestsetRowsRequestTestsetRowsItem": ".create_testset_rows_request_testset_rows_item",
    "CreateTestsetRowsResponseItem": ".create_testset_rows_response_item",
