...
class UpdateTestsetRequestColumnDefinitionsItem(UniversalBaseModel):
    ...
    type: typing.Optional[UpdateTestsetRequestColumnDefinitionsItemType] = pydantic.Field(default=None)
    """
    Column value type.
    """
