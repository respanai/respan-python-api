...
from .types.api_response_format_presets_create_response import ApiResponseFormatPresetsCreateResponse
from .types.api_response_format_presets_list_response import ApiResponseFormatPresetsListResponse
from .types.api_response_format_presets_partial_update_response import ApiResponseFormatPresetsPartialUpdateResponse
from .types.api_response_format_presets_retrieve_response import ApiResponseFormatPresetsRetrieveResponse
...
from .types.create_prompt_version_request_messages_item import CreatePromptVersionRequestMessagesItem
...
from .types.update_prompt_version_request_messages_item import UpdatePromptVersionRequestMessagesItem
...
class PromptsClient:
        ...
        *,
        ...
        client.prompts.process_prompt_bulk_operations(
            requests=[
                ...
                PromptBulkRequestItem_Commit(
                    prompt_id="prm_customer_support",
                    body=PromptBulkCommitBody(
                        description="Tune production configuration",
                    ),
                ),
                PromptBulkRequestItem_Deploy(
                    prompt_id="prm_customer_support",
    ...
    def create_prompt_version(
        ...
        prompt_id: str,
        *,
        messages: typing.Sequence[CreatePromptVersionRequestMessagesItem],
        description: typing.Optional[str] = OMIT,
        ...
        --------
        from respan import RespanClient
        from respan.prompts import CreatePromptVersionRequestMessagesItem
    ...
    def update_prompt_version(
        ...
        *,
        description: typing.Optional[str] = OMIT,
        messages: typing.Optional[typing.Sequence[UpdatePromptVersionRequestMessagesItem]] = OMIT,
        thinking: typing.Optional[typing.Dict[str, typing.Any]] = OMIT,
        model: typing.Optional[str] = OMIT,
        stream: typing.Optional[bool] = OMIT,
        temperature: typing.Optional[float] = OMIT,
        ...
        messages : typing.Optional[typing.Sequence[UpdatePromptVersionRequestMessagesItem]]
        ...
        --------
        from respan import RespanClient
        from respan.prompts import UpdatePromptVersionRequestMessagesItem
    ...
    def api_response_format_presets_list(
        ...
        *,
        ...
        client.prompts.api_response_format_presets_list()
        """
    ...
    def api_response_format_presets_create(
        ...
        *,
        ...
        client.prompts.api_response_format_presets_create(
            name="name",
    ...
    def api_response_format_presets_retrieve(
        ...
        client.prompts.api_response_format_presets_retrieve(
            id="id",
        )
        """
    ...
    def api_response_format_presets_destroy(
        ...
        client.prompts.api_response_format_presets_destroy(
            id="id",
        )
        """
    ...
    def api_response_format_presets_partial_update(
        ...
        *,
        ...
        client.prompts.api_response_format_presets_partial_update(
            id="id",
        )
        """
...
class AsyncPromptsClient:
    ...
    async def api_response_format_presets_list(
        ...
        *,
        ...
        async def main() -> None:
            await client.prompts.api_response_format_presets_list()
    ...
    async def api_response_format_presets_create(
        ...
        *,
        ...
        async def main() -> None:
            await client.prompts.api_response_format_presets_create(
                name="name",
                response_format_content="response_format_content",
            )
    ...
    async def api_response_format_presets_retrieve(
        ...
        async def main() -> None:
            await client.prompts.api_response_format_presets_retrieve(
                id="id",
            )
    ...
    async def api_response_format_presets_destroy(
        ...
        async def main() -> None:
            await client.prompts.api_response_format_presets_destroy(
                id="id",
            )
    ...
    async def api_response_format_presets_partial_update(
        ...
        *,
        ...
        async def main() -> None:
            await client.prompts.api_response_format_presets_partial_update(
                id="id",
            )
