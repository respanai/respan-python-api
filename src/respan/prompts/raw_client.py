...
class RawPromptsClient:
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                ...
                "messages": convert_and_respect_annotation_metadata(
                    object_=messages,
                    annotation=typing.Sequence[CreatePromptVersionRequestMessagesItem],
                    direction="write",
                ),
                "thinking": thinking,
                "model": model,
                ...
                "tool_choice": convert_and_respect_annotation_metadata(
                    object_=tool_choice, annotation=CreatePromptVersionRequestToolChoice, direction="write"
                ),
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                ...
                "messages": convert_and_respect_annotation_metadata(
                    object_=messages,
                    annotation=typing.Sequence[UpdatePromptVersionRequestMessagesItem],
                    direction="write",
                ),
                "thinking": thinking,
                "model": model,
                ...
                "tools": tools,
                "tool_choice": convert_and_respect_annotation_metadata(
                    object_=tool_choice, annotation=UpdatePromptVersionRequestToolChoice, direction="write"
                ),
                "response_format": response_format,
                "json_schema": json_schema,
                "is_enforcing_response_format": is_enforcing_response_format,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=ApiResponseFormatPresetsListResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=ApiResponseFormatPresetsCreateResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    ) -> HttpResponse[ApiResponseFormatPresetsRetrieveResponse]:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=ApiResponseFormatPresetsRetrieveResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=ApiResponseFormatPresetsPartialUpdateResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawPromptsClient:
    ...
    async def api_response_format_presets_retrieve(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[ApiResponseFormatPresetsRetrieveResponse]:
        """
        Retrieve the complete saved response-format schema text.
