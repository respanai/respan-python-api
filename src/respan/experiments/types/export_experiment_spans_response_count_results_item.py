...
class ExportExperimentSpansResponseCountResultsItem(UniversalBaseModel):
    ...
    scores: typing.Optional[typing.Dict[str, ExportExperimentSpansResponseCountResultsItemScoresValue]] = (
