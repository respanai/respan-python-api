...
from .list_experiment_spans_response_results_item_scores_value import ListExperimentSpansResponseResultsItemScoresValue


class ListExperimentSpansResponseResultsItem(UniversalBaseModel):
    ...
    scores: typing.Optional[typing.Dict[str, ListExperimentSpansResponseResultsItemScoresValue]] = pydantic.Field(
        default=None
    )
    """
