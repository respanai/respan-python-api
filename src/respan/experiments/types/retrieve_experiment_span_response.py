...
class RetrieveExperimentSpanResponse(UniversalBaseModel):
    ...
    scores: typing.Optional[typing.Dict[str, RetrieveExperimentSpanResponseScoresValue]] = pydantic.Field(default=None)
    """
    ...
    span_tree: typing.Optional[typing.List[RetrieveExperimentSpanResponseSpanTreeItem]] = pydantic.Field(default=None)
    """
